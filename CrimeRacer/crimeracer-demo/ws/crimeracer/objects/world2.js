...
CrimeRacer.World.prototype.setWorldBoxPosition = function() {
	...
	//var xDistance = myFunctionXPos();
		...
		this.myBoxesPosition.setPos(7000, 100, 7000);
...
CrimeRacer.World.prototype.reduceBombOfPlayer = function() {

	 this.myCar.reduceBombs();

}
CrimeRacer.World.prototype.reduceMinesOfPlayer = function() {

	 this.myCar.reduceMines();

}
CrimeRacer.World.prototype.reduceBulletsOfPlayer = function() {

	 this.myCar.reduceBullets();

}
CrimeRacer.World.prototype.getBombOfPlayer = function() {

	return this.myCar.getBomb();

}
CrimeRacer.World.prototype.getMinesOfPlayer = function() {

	return this.myCar.getMines();

}
CrimeRacer.World.prototype.getBulletsOfPlayer = function() {

	return this.myCar.getBullets();

}
CrimeRacer.World.prototype.setHealthControl = function(health) {

	return this.myCar.setHealth(health);

}
CrimeRacer.World.prototype.setMineCount = function(mines) {

	this.myCar.setMines(mines);

}
CrimeRacer.World.prototype.setBombCount = function(bomb) {

	this.myCar.setBomb(bomb);
...
CrimeRacer.World.prototype.setEnemyHealthControl = function(id, health) {
	...
	// if (id == 2) {
		// this.enemyCar = this.enemy.enemyCar3;
	// }
		this.enemyCar.setHealth(health);
}
